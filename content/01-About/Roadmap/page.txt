...
- <url href="http://scriptographer.org/tutorials/document-items/hit-tests/">Hit Test</url> graphic items and add mouse event handlers to them, for simple and powerful interactivity.
- <url href="http://scriptographer.org/tutorials/paths/geometric-tests/#finding-path-intersections">Path intersections</url>.
- Running Paper.js on the server using Node.js.

<title>Nearly Finished</title>
- <url href="http://scriptographer.org/tutorials/user-interface/interface-components/">Simple user interfaces</url> that allow your users to tweak values in your script.
...
- <url href="http://scriptographer.org/tutorials/paths/geometric-operations/">Boolean geometric path operations</url>, such as union, intersection, exclusion, etc.
