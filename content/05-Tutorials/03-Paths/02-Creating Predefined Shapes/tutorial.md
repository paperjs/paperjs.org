...
<note>A <api Rectangle /> object is an abstract representation of a rectangle. Please read the <node href="/tutorials/geometry/point-size-and-rectangle/" /> tutorial to find out how to work with the <code>Rectangle</code> object.</note>
